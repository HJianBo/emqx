    ...
    ets:foldl(
        fun(Stats, Acc) ->
            #stats{
                ...
                byte_sent = ByteSent,
                last_byte_receive = {ByteRecv0, _},
                byte_receive = ByteRecv,
            ...
            ets:update_element(?STATS, Tenant, [
                ...
                {#stats.last_byte_receive, {ByteRecv, rate(ByteRecv, ByteRecv0, Interval)}},
...
update_stats({Tenant, _}, Stats) ->
    ...
    UpdateOpts = [
        {#stats.byte_receive, RecvOct - LastRecvOct},
        {#stats.byte_sent, SendOct - LastSendOct}
    ],
    Default = #stats{
        tenant_id = Tenant,
        byte_receive = RecvOct,
        byte_sent = SendOct
    },
