...
fields(quota) ->
    [
        {max_connection, ?HOCON(integer(), #{desc => <<"Max connection">>, example => 10000})},
        {max_conn_rate, ?HOCON(integer(), #{desc => <<"Max connection rate">>, example => 1000})},
        {max_messages_in, ?HOCON(integer(), #{desc => <<"Max messages in">>, example => 1000})},
        {max_bytes_in, ?HOCON(integer(), #{desc => <<"Max bytes in">>, example => 100000})},
        {max_subs_rate, ?HOCON(integer(), #{desc => <<"Max subscriptions rate">>, example => 500})},
        {max_authn_users, ?HOCON(integer(), #{desc => <<"Max authn users">>, example => 10000})},
        {max_authz_users, ?HOCON(integer(), #{desc => <<"Max authz users">>, example => 10000})},
        {max_retained_messages,
            ?HOCON(integer(), #{desc => <<"Max retained messages">>, example => 1000})},
        {max_rules, ?HOCON(integer(), #{desc => <<"Max rules">>, example => 1000})},
        {max_resources, ?HOCON(integer(), #{desc => <<"Max resources">>, example => 50})},
        {max_shared_subscriptions,
            ?HOCON(integer(), #{desc => <<"Max shared subscriptions">>, example => 100})},
        {min_keepalive, ?HOCON(integer(), #{desc => <<"Min keepalive second">>, example => 30})},
        {max_keepalive, ?HOCON(integer(), #{desc => <<"Max keepalive">>, example => 3600})},
